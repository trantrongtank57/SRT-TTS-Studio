...
# Onefile-SECURED build — produces SRT_TTS_Studio_Secured.exe
# After PyInstaller, gen_self_hash.py creates a companion .integrity file.
# At runtime, _check_self_integrity() verifies the exe against the companion.
# Distributing without the companion file → app aborts immediately.
#
...
a = Analysis(
    ...
    datas=[
        ...
        ('error.wav',                  '.'),
        ('build_type_secured.dat',     '.'),   # marker: secured build
