...
for %%f in (rvc_helper.py voxcpm_helper.py whisper_stt.py audio_enhancer.py pdf_helper.py srt_align_helper.py videocr_helper.py video_stt_helper.py translate_helper.py vieneu_helper.py f5tts_helper.py) do (
    if exist "%%f" (
...
for %%f in (rvc_helper.py voxcpm_helper.py whisper_stt.py audio_enhancer.py pdf_helper.py srt_align_helper.py videocr_helper.py video_stt_helper.py translate_helper.py vieneu_helper.py f5tts_helper.py hubert_base.pt rmvpe.pt) do (
